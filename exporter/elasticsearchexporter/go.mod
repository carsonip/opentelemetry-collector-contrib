...
require (
	...
	github.com/elastic/go-docappender v0.0.0-00010101000000-000000000000
...
replace github.com/elastic/go-docappender => github.com/carsonip/go-docappender v1.0.1-0.20240409154150-40368128a4c4
