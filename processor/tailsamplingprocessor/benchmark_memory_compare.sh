...
echo
printf "%-10s %8s %10s %10s %10s %10s %12s\n" "mode" "samples" "peak_mb" "avg_mb" "final_mb" "recv_sps" "sampled_sps"
printf "%-10s %8s %10s %10s %10s %10s %12s\n" "inmemory" "$im_samples" "$im_peak" "$im_avg" "$im_final" "$im_recv_sps" "$im_sampled_sps"
printf "%-10s %8s %10s %10s %10s %10s %12s\n" "pebble" "$pb_samples" "$pb_peak" "$pb_avg" "$pb_final" "$pb_recv_sps" "$pb_sampled_sps"
echo
