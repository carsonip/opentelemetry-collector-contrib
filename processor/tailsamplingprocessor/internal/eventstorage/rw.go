...
func (s SplitReadWriter) ReadTraceEvents(traceID string, out *Batch) error {
...
func (s StorageLimitReadWriter) ReadTraceEvents(traceID string, out *Batch) error {
...
func (s StorageLimitReadWriter) WriteTraceEvent(traceID, id string, events *Events) error {
	...
	return s.nextRW.WriteTraceEvent(traceID, id, events)
}
