module github.com/open-telemetry/opentelemetry-collector-contrib/cmd/telemetrygen/e2etest

go 1.21

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/cmd/telemetrygen v0.93.0
